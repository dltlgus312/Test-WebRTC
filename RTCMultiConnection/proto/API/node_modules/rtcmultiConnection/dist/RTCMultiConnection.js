    ...
    var FileProgressBarHandler = (function() {
        function handle(connection) {
            ...
            connection.addFile = function(file, container) {
            	...
            	connection.filesContainer.removeChild(container);
            	...
            	if(!table){
            		...
            		table.innerHTML = '<tr><th style="border:' + borderStyle + '">파일명</th><th style="border:' + borderStyle + '">크기</th><th style="border:' + borderStyle + '">날짜</th><th style="border:' + borderStyle + '">게시자</th><th style="border:' + borderStyle + '"></th></tr>'
            	...
            	var fileName = '<tr><td style="border:' + borderStyle + '"><a href="' + file.url + '" download="' + file.name + '"><strong style="color:white;">' + file.name + '</strong> </a></td>';
            	var fileSize = '<td style="border:' + borderStyle + '"><strong style="color:white;">' + file.size + 'byte</strong></td>';
            	var dateTime = '<td style="border:' + borderStyle + '"><strong style="color:white;">' + date + '</strong></td>';
            	var userName = '<td style="border:' + borderStyle + '"><strong style="color:white;">' + file.userid + '</strong></td>';
            	var view;

            	if (file.type && file.type.indexOf('image') != -1) {
            		view = '<td style="border:' + borderStyle + '"><img src="' + file.url + '" title="' + file.name + '" style="max-width: 80%;"></td>';
            	} else {
                	view = '<td style="border:' + borderStyle + '"><iframe src="' + file.url + '" title="' + file.name + '" style="width: 80%;border: 0;height: inherit;margin-top:1em;"></iframe></td>';
                }

            	if(connection.viewer){
            		table.innerHTML = table.innerHTML + fileName + fileSize + dateTime + userName + view;
            	}else {
            		table.innerHTML = table.innerHTML + fileName + fileSize + dateTime + userName;
            	}
