    ...
    var FileProgressBarHandler = (function() {
        function handle(connection) {
            ...
            connection.onFileStart = function(file, isProvider) {
                ...
                if (file.remoteUserId) {
                    div.innerHTML += '<div style="width:100%">';
	                    ...
	                    div.innerHTML += '파일크기 : ' + (~~file.size / 1024 / 1024).toFixed(2) + 'MB</br>';
            ...
            connection.addFile = function(file, container) {
        		...
        		fileSize.innerHTML = '<strong style="color:white;">' + (~~file.size / 1024 / 1024).toFixed(2) + 'MB</strong>';
...
//            					}
    ...
    (function(connection) {
        ...
        // ################### fileSync ###################### 
        connection.fileSync = function(remoteUserid){
        	if(connection.fbr && connection.fbr.chunks){
        		for(var uuid in connection.fbr.chunks){
        			
        			var chunk = connection.fbr.chunks[uuid]; 

        			if(chunk[0].userid != connection.userid && !chunk[chunk[0].maxChunks + 1]) continue;
