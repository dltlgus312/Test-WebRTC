    ...
    var FileProgressBarHandler = (function() {
        function handle(connection) {
            ...
            connection.onFileStart = function(file) {
                ...
                div.setAttribute('class', 'fileSharing sharing_' + file.userid + ' sharing_' + file.remoteUserId);
                
                div.innerHTML = '<div style="width:100%"><progress></progress><label style="margin-left:10px">0%</label><input type="hidden" value=' + file.uuid + '></div>';

                if (file.remoteUserId) {
                    div.innerHTML += '<div style="width:100%">파일명 : ' + file.name + '</br>크기 : ' + file.size + '</br>게시자 : ' + file.userid + '</div>';
                }
            ...
            connection.addFile = function(file, container) {
        		...
        		fileSize.innerHTML = '<strong style="color:white;">' + file.size + 'byte</strong>';
        		fileDate.innerHTML = '<strong style="color:white;">' + date + '</strong>';
        		userName.innerHTML = '<strong style="color:white;">' + file.userid + '</strong>';
        		...
        		tr.id = 'shared_' + file.uuid + file.userid;
        		...
        		// ## Notice Event
            	connection.onnoticemessage(file.userid, 'shareFile', file);
            ...
            connection.stopOrDel = function(type, userid, uuid){
            	if(type == 'shared'){
            		...
            		if(uuid){
            			...
            			var eleList = document.getElementsByClassName("sharing_" + userid);
