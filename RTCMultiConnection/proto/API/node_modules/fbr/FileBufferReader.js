...
(function() {
    ...
    function FileBufferReader() {
        ...
        fbr.getNextChunk = function(fileUUID, callback, userid, provideId) {
            var currentPosition;
            ...
            if (typeof userid !== 'undefined') {
                ...
                // ## add Separator (fileUUID) ##
                if(!fbr.users[userid + ''][fileUUID]){
                	fbr.users[userid + ''][fileUUID] = {
                			fileUUID: fileUUID,
                			userid: userid,
                			currentPosition: -1
                	};
                ...
                if(provideId){
                	fbr.users[userid + ''][fileUUID].currentPosition = -1;
                }
                // ##############################

                if (typeof currentPosition !== 'undefined') {
                    fbr.users[userid + ''][fileUUID].currentPosition = currentPosition;
                }

                fbr.users[userid + ''][fileUUID].currentPosition++;
                currentPosition = fbr.users[userid + ''][fileUUID].currentPosition;
            } else {
                if (typeof currentPosition !== 'undefined') {
            ...
            if (typeof provideId !== 'undefined') {
            	nextChunk.provideId = provideId + '';
            }
        ...
        fbr.addChunk = function(chunk, callback) {
            ...
            // ## Chunk Sync ##
            if (!fbr.users[chunk.userid + '']) {
                fbr.users[chunk.userid + ''] = [];
            }
            
            if(!fbr.users[chunk.userid + ''][chunk.uuid]){
            	fbr.chunks[chunk.uuid] = {};
            	fbr.users[chunk.userid + ''][chunk.uuid] = {};
            }
    ...
    function FileBufferReaderHelper() {
        ...
        fbrHelper.readAsArrayBuffer = function(fbr, options) {
        	!fbrHelper.fbr ? fbrHelper.fbr = fbr : '';
