...
//                    }
        ...
        init: function(index) {
            if (!points.length || !shapeSelectList.length || !points[index - 1][1]) return;
...
//                tempContext.fill();
        ...
        dragShape: function(x, y) {
            ...
            // ## last path
            var point = points[selectedIndex == '' ? points.length - 1 : selectedIndex - 1];
...
//                    ];
        ...
        dragLastPath: function(x, y) {
        	...
        	// ## last path
            if (!points[selectedIndex == '' ? points.length - 1 : selectedIndex - 1]) return;
