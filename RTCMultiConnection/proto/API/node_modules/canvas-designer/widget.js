...
(function() {
    ...
    function pointsSave(type){
    	...
    	if(type != 'save'){
    		...
    		points = pdf.concat(savePoints[pdfHandler.openedKey][pdfHandler.prePageNumber][0]);
    	}
    }
...
//                    }
        ...
        init: function(index) {
            if (!points.length || !shapeSelectList.length) return;
