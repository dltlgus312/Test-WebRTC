...
<head>
    ...
    <style>
        ...
        .shape-select-container::-webkit-scrollbar{
        	width:0;
    		background-color:transparent;
        }
...
/*             cursor: pointer; */
        ...
        #page-next, #page-prev, #page-close {
            width: 22px;
            vertical-align: middle;
            cursor: pointer;
        }
...
<body>
    ...
    <section id="tool-box" class="tool-box">
		...
		<canvas id="do" width="40" height="40" title="do: Removed Shapes Re Draw" ></canvas>
		
        <canvas id="clear" width="40" height="40" title="Clear All: Clear All"></canvas>
        <canvas id="paging" width="40" height="40" title="paging: paging"></canvas>
        <canvas id="fullScreen" width="40" height="40" title="fullScreen: fullScreen"></canvas>
    ...
    <section id="line-width-container" class="context-popup">
        ...
        <div id="line-width-done" class="btn-007">확인</div>
    </section>
    ...
    <section id="colors-container" class="context-popup colors-container">
        ...
        <div id="colors-done" class="btn-007">확인</div>
    </section>
    ...
    <section id="marker-container" class="context-popup colors-container">
        ...
        <div id="marker-done" class="btn-007">확인</div>
    </section>
    ...
    <!-- eraser selector -->
    <!-- custom -->
    <section id="eraser-container" class="context-popup colors-container">
        <div class="input-div" style="display:inline-block;padding:10px;">
            <label for="eraser-stroke-style">WIDTH:</label>
            <select id="eraser-stroke-style">
        ...
        <!-- custom -->
        <!-- <div id="eraser-done" class="btn-007">확인</div>  -->
    </section>
    ...
    <section id="pencil-container" class="context-popup colors-container">
		<div style="display:inline-block;padding:7px;">
	        <span class="input-div">
	            <label for="pencil-stroke-style">WIDTH:</label>
	        ...
	        <span class="input-div" id='pencil-color-container'>
	            <label for="pencil-fill-style">COLOR:</label>
	            <span id="pencil-selected-color"></span>
	            <input id="pencil-fill-style" type="text" value="000000">
	        </span>
	        
	        <div id="pencil-fill-colors" class='context-popup' style="height:auto; width:110px;">
	            <table id="pencil-colors-list">
	
	            </table>
	        </div>
			<!-- custom -->
	        <!-- <div id="pencil-done" class="btn-007">확인</div> -->
	    </div>
    </section>
    ...
    <section id="pdf-select-container" class="context-popup pdf-select-container">
    	<div style="display:inline-block;padding:7px;">
	        <select id="pdf-select-list">
	        	<option value="empty">PDF 파일을 선택 해주세요</option>
	        </select>
	       	<button id="pdf-select"> 파일 찾기 </button>
	       	<button id="pdf-save"> 저장</button>
    	</div>
    </section>
    ...
    <section id="shape-select-container" class="shape-select-container">
    ...
    <section id="additional-container" class="context-popup additional-container">
        ...
        <div id="additional-close" class="btn-007">확인</div>
    </section>
